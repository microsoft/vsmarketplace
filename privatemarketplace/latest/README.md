...
1. Sign into our Azure Container Registry and pull down the container.
   ```powershell
   # use the username and password provided by our team
...
- Use a custom container registry pointed to `privatemarketdogfoodwestus2.azurecr.io` while configuring the Container App.
...
<!--
You can use https://mermaid.live/edit to render the SVG.
...
<!--
You can use https://mermaid.live/edit to render the SVG.
Remove the spaces in the arrows to fix the diagram
