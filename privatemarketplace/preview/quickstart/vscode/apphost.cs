...
public static class MarketplaceExtensions
{
    ...
    /// </summary>
    public const string MarketplaceResourceName = "vscode-private-marketplace";
        ...
        string containerImage = "mcr.microsoft.com/vsmarketplace/vscode-private-marketplace")
    {
        ...
        var marketplace = builder.AddContainer(name, containerImage)
            ...
            .WithUrl($"https://github.com/microsoft/vsmarketplace/blob/main/privatemarketplace/preview/quickstart/vscode/README.md", "README")
