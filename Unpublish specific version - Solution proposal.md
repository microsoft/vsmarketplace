...
- To prevent large-scale disruption to extension consumers, versions with over 1 million installs will only be removable by emailing Marketplace customer support.
